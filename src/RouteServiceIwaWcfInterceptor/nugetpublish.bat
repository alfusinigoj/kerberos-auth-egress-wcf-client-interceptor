...
nuget pack RouteServiceIwaWcfInterceptor.csproj -Version 1.0.%1 -OutputDirectory _publish

IF %ERRORLEVEL% NEQ 0 GOTO ERROR

nuget add _publish/Pivotal.WcfClient.Kerberos.Interceptor.1.0.%1.nupkg -Source c:\MyLocalNugetRepo
